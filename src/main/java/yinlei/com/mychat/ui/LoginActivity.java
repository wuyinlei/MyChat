...
import yinlei.com.mychat.db.AccountDao;
import yinlei.com.mychat.domain.Account;
import yinlei.com.mychat.fragment.FillInfoFragment;
import yinlei.com.mychat.fragment.LogoFragment;
import yinlei.com.mychat.fragment.SignInFra;
import yinlei.com.mychat.fragment.SignUpFra;
import yinlei.com.mychat.ui.base.BaseActivity;
import yinlei.com.mychat.widget.NormalTopBar;
...
public class LoginActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (enterFlag == ENTER_FIRST) {
			...
			currentFra = new LogoFragment();
			Bundle args = new Bundle();
			args.putInt(LogoFragment.ARG_KEY, LogoFragment.ARG_TYPE_LOGINED);
			currentFra.setArguments(args);
			currentTag = TAG_LOGO;
