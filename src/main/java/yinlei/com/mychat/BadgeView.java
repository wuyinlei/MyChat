...
public class BadgeView extends TextView {
    ...
    private static final int DEFAULT_CORNER_RADIUS_DIP = 2;
    ...
    public void draw(Canvas canvas) {
        ...
        mBgPaint.setColor(DEFAULT_BADGE_COLOR);
        // canvas.setDrawFilter(pfd);//给Canvas加上抗锯齿标志

        int radius = 12;

        canvas.drawCircle(getWidth() / 2, getHeight() / 2, Math.min(getWidth(), getHeight()) / 2, mBgPaint);
